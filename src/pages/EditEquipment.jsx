...
const EditEquipment = () => {
  ...
  useEffect(() => {
    const fetchEquipment = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/equipment/${id}`);
  ...
  return (
    <div className="min-h-screen px-6 py-10">
      <h2 className="text-3xl font-bold text-center mb-8 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">
        Edit Equipment
      </h2>
      ...
      >
        <div className="mb-5">
          <label className="block text-left text-sm text-gray-300 mb-1">Equipment Name</label>
          <input
            type="text"
